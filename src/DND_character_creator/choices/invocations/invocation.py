...
class Invocation(BaseClass):
    name: str
    description: str
    required_level: int
    required_subclass: Optional[WarlockPact]
...
invocations = [
    ...
    Invocation(
        ...
        required_level=0,
        required_subclass=WarlockPact.PACT_OF_THE_TOME,
    ),
    Invocation(
        name="Beast Speech",
    ...
    Invocation(
        ...
        " to them.",
        required_level=12,
        required_subclass=WarlockPact.PACT_OF_THE_TALISMAN,
    ),
    Invocation(
    ...
    Invocation(
        ...
        required_level=15,
        required_subclass=WarlockPact.PACT_OF_THE_CHAIN,
    ),
    Invocation(
        name="Cloak of Flies",
    ...
    Invocation(
        ...
        required_level=5,
        required_subclass=WarlockPact.PACT_OF_THE_BLADE,
    ),
    Invocation(
        name="Eldritch Spear",
...
def n_invocation(character_wrapper: CharacterWrapper) -> int:
    conditions = [
